...
String toString() {
  final _this = this as HomeItemDto;
  return 'HomeItemDto(id: ${_this.id}, title: ${_this.title}, subtitle: ${_this.subtitle}, isFavorite: ${_this.isFavorite})';
}
...
/// Create a copy of HomeItemDto
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? id = null,Object? title = null,Object? subtitle = freezed,Object? isFavorite = null,}) {
...
class _HomeItemDto extends HomeItemDto {
  const _HomeItemDto({required this.id, required this.title, this.subtitle, this.isFavorite = false}): super._();
...
@override
bool operator ==(Object other) {
    return identical(this, other) || (other.runtimeType == runtimeType&&other is _HomeItemDto&&(identical(other.id, id) || other.id == id)&&(identical(other.title, title) || other.title == title)&&(identical(other.subtitle, subtitle) || other.subtitle == subtitle)&&(identical(other.isFavorite, isFavorite) || other.isFavorite == isFavorite));
}
...
@override
String toString() {
    return 'HomeItemDto(id: $id, title: $title, subtitle: $subtitle, isFavorite: $isFavorite)';
}
...
/// Create a copy of HomeItemDto
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? id = null,Object? title = null,Object? subtitle = freezed,Object? isFavorite = null,}) {
